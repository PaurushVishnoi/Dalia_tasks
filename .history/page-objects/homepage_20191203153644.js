module.exports = {
    ...
    loginFailure : '.growl.error.clickable',
    searchBox : '.no-search-decoration',
    linkSection : '#sidebar',
    linkClick : '[data-menu-item-id = "5de4be296fe509baf503dfeb"]',
    newPost : 'a.create-link',
    articleSection : '.ReactVirtualized__Grid__innerScrollContainer'
}