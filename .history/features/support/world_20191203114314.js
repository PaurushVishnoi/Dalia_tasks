...
class CustomWorld {
    ...
    async fillLoginForm(){
        await this.page.type(loginpage.userName, inputs.nameInput)
        await this.page.type(loginpage.userPassword, inputs.passwordInput)
    }
    ...
    async loginRegisteredUser(){
        ...
        await this.page.waitForSelector(loginpage.loginBox)
        await this.page.click(loginpage.loginButton)
        await this.page.type(homepage.userName, inputs.nameInput)
        await this.page.type(homepage.userPassword, inputs.passwordInput)
    ...
    async enterSearch(){
        ...
        await this.page.type(homepage.searchBox,inputs.titleInput)
